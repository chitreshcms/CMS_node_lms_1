...
const SubjectTeacherMap = DB.define('subject-teacher-map', {}, {
    timestamps: false
})
...
// Subject - teacher map
Subject.hasMany(SubjectTeacherMap)
SubjectTeacherMap.belongsTo(Subject)
Teacher.hasOne(SubjectTeacherMap)
Lecture.hasOne(SubjectTeacherMap)
